...
<form action="{{route('customermaster.update',$customermaster->id)}}" id="cus_formdata" method="POST">
    @csrf
    @method('PUT')
...
<div class="row d-flex justify-content-center">
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header d-flex" style="justify-content:space-between"><span> <b>Customer Updation</b></span><a class="btn btn-sm btn-primary" href="{{route('customermaster.index')}}">Customer List</a>
            </div>
            <div class="card-body">
                <div class="row">
                    <input type="hidden" name="id" id="cus_id" value="{{$customermaster->id}}">
                    <input type="hidden" name="updated_by" id="updated_by" value="{{$updated_by}}">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="cus_code">Code *</label>
                            <input type="text" name="cus_code" id="cus_code" value="{{$customermaster->cus_code}}" class="form-control @error('cus_code') is-invalid @enderror" >
                            @error('cus_code')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="supplier_vendor_code"  value="{{$customermaster->supplier_vendor_code}}" id="supplier_vendor_code" class="form-control @error('supplier_vendor_code') is-invalid @enderror" >
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="supplytype"  id="supplytype" value="{{$customermaster->supplytype}}" class="form-control @error('supplytype') is-invalid @enderror" >
                            @error('supplytype')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cus_name" id="cus_name" value="{{$customermaster->cus_name}}" class="form-control @error('cus_name') is-invalid @enderror" >
                                    @error('cus_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cus_address" id="cus_address" value="{{$customermaster->cus_address}}" class="form-control @error('cus_address') is-invalid @enderror" >
                                    @error('cus_address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cus_address1" id="cus_address1" value="{{$customermaster->cus_address1}}" class="form-control @error('cus_address1') is-invalid @enderror" >
                                    @error('cus_address1')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cus_city"  id="cus_city" value="{{$customermaster->cus_city}}" class="form-control @error('cus_city') is-invalid @enderror" >
                                    @error('cus_city')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cus_state"  id="cus_state" value="{{$customermaster->cus_state}}" class="form-control @error('cus_state') is-invalid @enderror" >
                                    @error('cus_state')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cus_country"  id="cus_country" value="{{$customermaster->cus_country}}" class="form-control @error('cus_country') is-invalid @enderror" >
                                    @error('cus_country')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cus_pincode"  id="cus_pincode" value="{{$customermaster->cus_pincode}}" class="form-control @error('cus_pincode') is-invalid @enderror" >
                                    @error('cus_pincode')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="delivery_cus_name" value="{{$customermaster->delivery_cus_name}}" id="delivery_cus_name" class="form-control @error('delivery_cus_name') is-invalid @enderror" >
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="delivery_cus_address" value="{{$customermaster->delivery_cus_address}}" id="delivery_cus_address" class="form-control @error('delivery_cus_address') is-invalid @enderror" >
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="delivery_cus_address1" value="{{$customermaster->delivery_cus_address1}}" id="delivery_cus_address1" class="form-control @error('delivery_cus_address1') is-invalid @enderror" >
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="delivery_cus_city" value="{{$customermaster->delivery_cus_city}}"  id="delivery_cus_city" class="form-control @error('delivery_cus_city') is-invalid @enderror" >
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="delivery_cus_state" value="{{$customermaster->delivery_cus_state}}" id="delivery_cus_state" class="form-control @error('delivery_cus_state') is-invalid @enderror" >
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="delivery_cus_country" value="{{$customermaster->delivery_cus_country}}"  id="delivery_cus_country" class="form-control @error('delivery_cus_country') is-invalid @enderror" >
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="delivery_cus_pincode" value="{{$customermaster->delivery_cus_pincode}}"  id="delivery_cus_pincode" class="form-control @error('delivery_cus_pincode') is-invalid @enderror" >
...
$(document).ready(function(){
    ...
    $("#cus_code").change(function(e){
        ...
        $("#btn").val('Save');
        $.ajax({
            url: "{{ route('customerseditdata') }}",
            method: 'POST',
            data:{"cus_id":cus_id,"cus_code":customer_code},
