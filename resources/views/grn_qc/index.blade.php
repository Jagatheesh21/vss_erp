                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="me-auto">
                                        ...
                                        <a href="{{route('grn_iqc.approval',$grnqc_data->id)}}" data-toggle="tooltip"  data-id="{{$grnqc_data->id}}" class="btn btn-sm py-0 mx-2 btn-info"><i class='bx bxs-edit' style='color:white;'>&nbsp;</i></a>
                                        @else
                                        @endif
                                    </td>
                                </tr>
