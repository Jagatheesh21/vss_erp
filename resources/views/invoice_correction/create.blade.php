                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    @forelse ($invoiceDetails as $invoiceDetails)
                                        <option name="invoice_number" value="{{$invoiceDetails->invoice_number}}" selected>{{$invoiceDetails->rcmaster->rc_id}}</option>
                                    @empty
                                    @endforelse
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="invoice_date" class="form-control bg-light @error('invoice_date') is-invalid @enderror" readonly>
                                    @error('invoice_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control  bg-light @error('name') is-invalid @enderror"  readonly >
                                    @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="Number" name="rate" class="form-control  bg-light @error('rate') is-invalid @enderror" readonly >
                                    @error('rate')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
