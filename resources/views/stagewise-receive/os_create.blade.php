...
<div class="row d-flex justify-content-center">
    ...
    @endif
        ...
        <div class="card">
            <div class="card-header d-flex" style="justify-content:space-between"><span> <b>Out Store Part Receive Register</b></span><a class="btn btn-sm btn-primary" href="{{route('osreceive')}}">Out Store Part Receive List</a>
            </div>
            <div class="card-body">
                        <div class="row d-flex justify-content-center">
