                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="table">
                                    <table class="logo_table">
                                          <tr>
                                            <td colspan="2" rowspan="4" class="logo_table"><img src="{{asset('image/fav_icon.png')}}" alt="Mountain View" style="width:60%;height:10%;background-color:#086cdd;vertical-align:center"></img></td>
                                            <td class="tg-bn4o" colspan="12" class="logo_table" style="font-weight:bold;font-size:18px;text-align:center!important;vertical-align:top">VENKATESWARA STEELS AND SPRINGS (INDIA) PVT LTD</td>
