...
@foreach ($dc_transactionDatas as $key => $dc_transactionData)
    ...
    <td><select name="dc_id[{{$dc_transactionData->dc_print_id}}]" class="form-control bg-light dc_id" readonly id="dc_id"><option value="{{$dc_transactionData->dc_id}}" selected>{{$dc_transactionData->dc_no}}</option></select></td>
    ...
    <td><input type="number" name="issue_qty[{{$dc_transactionData->dc_print_id}}]"  class="form-control bg-light issue_qty" readonly  id="issue_qty" value="{{$dc_transactionData->issue_qty}}"></td>
    <td><input type="number" name="receive_qty[{{$dc_transactionData->dc_print_id}}]"  class="form-control receive_qty" id="receive_qty" value="{{$dc_transactionData->issue_qty}}" maximum="{{$dc_transactionData->issue_qty}}"></td>
    <td><input type="number" name="balance_qty[{{$dc_transactionData->dc_print_id}}]"  class="form-control balance_qty  bg-light" readonly id="balance_qty" value="{{($dc_transactionData->issue_qty)-($dc_transactionData->issue_qty)}}"></td>
