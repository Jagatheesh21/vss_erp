...
<div class="row d-flex justify-content-center">
    ...
    @endif
        <div class="card">
            <div class="card-header d-flex" style="justify-content:space-between"><span><b>Semi Finished Store Issuance Register List</b>  </span>
                <a class="btn btn-md btn-primary" href="{{route('sfissue.create')}}"><b><i class='bx bx-plus bx-flashing' style='color:white;' ></i>&nbsp;&nbsp; New</b></a>
            </div>
            <div class="card-body">
                <div class="table">
