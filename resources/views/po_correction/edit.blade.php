    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <form action="{{route('po-correction.update',$poCorrection->id)}}" id="pocorrection_formdata"  method="POST">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="id" id="id" value="{{$poCorrection->id}}">
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="po_corrections_date">Requested Date *</label>
                                    <input type="date" name="po_corrections_date" class="form-control bg-light @error('po_corrections_date') is-invalid @enderror" readonly value="{{$poCorrection->po_corrections_date}}">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="request_reason">REQUESTED REASON *</label>
                                    <textarea name="request_reason" id="request_reason" readonly class="form-control bg-light @error('request_reason') is-invalid @enderror" cols="20" rows="3">{{$poCorrection->request_reason}}</textarea>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option value="0" @if($poCorrection->status==0) selected @endif>Pending</option>
                                        <option value="1" @if($poCorrection->status==1) selected @endif >Approve</option>
                                        <option value="2" @if($poCorrection->status==2) selected @endif>Reject</option>
                                    </select>
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="approve_reason">REASON *</label>
                                        <textarea name="approve_reason" id="approve_reason"  class="form-control @error('approve_reason') is-invalid @enderror" cols="20" rows="3">{{$poCorrection->approve_reason}}</textarea>
                                        @error('approve_reason')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="approved_date" class="form-control bg-light @error('approved_date') is-invalid @enderror" readonly value="{{date('Y-m-d')}}">
                                        @error('approved_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
